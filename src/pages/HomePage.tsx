          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                ...
                <a
                  href="https://www.instagram.com/vanica.lb"
                  target="_blank"
                ...
                >
                  ...
                  >
                    <Button
                      variant="outline"
                      size="lg"
                      className="px-12 py-4 bg-white/60 backdrop-blur-sm text-slate-700 rounded-full border border-lavender/50 hover:bg-lavender/10 transition-all duration-300 shadow-lg"
                    >
                      View Portfolio
                    </Button>
                  </motion.div>
                    ...
                    <div className="mb-4 flex justify-center items-center h-20">
                      {service.image ? (
                        <img
                          src={service.image}
                          alt={service.title}
                          className="w-28.05 h-28.05 object-contain"
                        />
                      ) : (
          ...
          >
            ...
            <Link to="/booking">
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <Button size="lg" className="px-8 sm:px-12 py-4 bg-[#ffd5f0] text-white rounded-full hover:bg-[#f8c2e4] transition-all duration-300 shadow-2xl">
                  Start Planning Now
                </Button>
              </motion.div>
            </Link>
